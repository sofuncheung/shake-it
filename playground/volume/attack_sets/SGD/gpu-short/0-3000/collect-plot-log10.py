...
for dirs in dir_list:
    ...
    try:
        ...
        sensitivity_logits.append(record[:,2])
        sensitivity_sigmoid.append(record[:,3])
        robustness_logits.append(record[:,4])
        robustness_sigmoid.append(record[:,5])
        sensitivity_logits_test.append(record[:,6])
        sensitivity_sigmoid_test.append(record[:,7])
        robustness_logits_test.append(record[:,8])
        robustness_sigmoid_test.append(record[:,9])
        volume.append(record[:,10])
    except:
...
fig.text(0.5,0.25,'ResNet50/CIFAR-10', bbox=dict(facecolor='none'), fontsize=20)
fig.savefig('sharpness-generalization-resnet50-SGD.png', dpi=300)
plt.clf()
...
ax.tick_params(direction='in')
fig.savefig('sensitivity_logits-generalization-resnet50-SGD.png', dpi=300)
plt.clf()
...
ax.set_ylabel('Generalization (%)',fontdict={'fontsize': 20, 'fontweight': 'medium'})
ax.tick_params(direction='in')
fig.savefig('sensitivity_sigmoid-generalization-resnet50-SGD.png', dpi=300)
plt.clf()
...
ax.set_ylabel('Generalization (%)',fontdict={'fontsize': 20, 'fontweight': 'medium'})
ax.tick_params(direction='in')
fig.savefig('robustness_logits-generalization-resnet50-SGD.png', dpi=300)
plt.clf()
...
ax.set_ylabel('Generalization (%)',fontdict={'fontsize': 20, 'fontweight': 'medium'})
ax.tick_params(direction='in')
fig.savefig('robustness_sigmoid-generalization-resnet50-SGD.png', dpi=300)
plt.clf()
...
ax.set_ylabel('Generalization (%)',fontdict={'fontsize': 20, 'fontweight': 'medium'})
ax.tick_params(direction='in')
fig.savefig('sensitivity_logits_test-generalization-resnet50-SGD.png', dpi=300)
plt.clf()
...
ax.set_ylabel('Generalization (%)',fontdict={'fontsize': 20, 'fontweight': 'medium'})
ax.tick_params(direction='in')
fig.savefig('sensitivity_sigmoid_test-generalization-resnet50-SGD.png', dpi=300)
plt.clf()
...
ax.set_ylabel('Generalization (%)',fontdict={'fontsize': 20, 'fontweight': 'medium'})
ax.tick_params(direction='in')
fig.savefig('robustness_logits_test-generalization-resnet50-SGD.png', dpi=300)
plt.clf()
...
ax.set_ylabel('Generalization (%)',fontdict={'fontsize': 20, 'fontweight': 'medium'})
ax.tick_params(direction='in')
fig.savefig('robustness_sigmoid_test-generalization-resnet50-SGD.png', dpi=300)
plt.clf()
...
ax.tick_params(direction='in')
fig.text(0.5,0.25,'ResNet50/CIFAR-10', bbox=dict(facecolor='none'), fontsize=20)
fig.savefig('volume-generalization-resnet50-SGD.png', dpi=300)
plt.clf()
